...
def ModelDieselTotal():
    ...
    callback_list_test =[
        keras.callbacks.ModelCheckpoint(
            filepath="./dataTimeDieselTotal/"+now_s+'.h5',      ##文件路径 存在当前路径下吧 还好找
    ...
    input = layers.Input(shape=(401, 1), dtype='float32')
    ...
    b_1 = layers.Conv1D(4, 3, activation=jihuo)(b_1)

    b_2 = layers.Conv1D(16, 5, activation=jihuo)(net)
    b_2 = layers.Conv1D(16, 3, activation=jihuo, padding='valid')(b_2)
    b_2 = layers.Conv1D(4, 3, activation=jihuo)(b_2)

    b_3 = layers.Conv1D(16, 7, activation=jihuo)(net)
    b_3 = layers.Conv1D(16, 3, activation=jihuo, padding='valid')(b_3)
    b_3 = layers.Conv1D(4, 3, activation=jihuo)(b_3)

    b_4 = layers.AvgPool1D(5)(net)
    b_4 = layers.Conv1D(16, 7, activation=jihuo)(b_4)
    b_4 = layers.Conv1D(8, 1, activation=jihuo, padding='valid')(b_4)
    b_4 = layers.Conv1D(4, 3, activation=jihuo)(b_4)

    b_5 = layers.AvgPool1D(4)(net)
    b_5 = layers.Conv1D(16, 5, activation=jihuo)(b_5)
    b_5 = layers.Conv1D(16, 3, activation=jihuo, padding='valid')(b_5)
    b_5 = layers.Conv1D(4, 3, activation=jihuo)(b_5)
    ...
    model = load_model("./dataTimeDieselTotal/"+now_s+'.h5')
